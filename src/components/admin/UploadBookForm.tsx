  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl">
      ...
      <fieldset className="space-y-3">
        <legend className="text-sm font-semibold">Book Title (Multilingual)</legend>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="text-sm font-semibold block mb-1">{b.author}</label>
          <select
            name="author_id"
            required
      ...
      {/* PDF Upload */}
      <div>
        <label className="text-sm font-semibold block mb-1">PDF File</label>
